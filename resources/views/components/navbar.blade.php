        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="px-36 ml-10 flex items-baseline space-x-4 ">
            ...
            <div class="hidden md:block">
                <div class="ml-10 flex items-center md:ml-6">
                    <!-- Profile dropdown -->
                    <div class="relative ml-3">
                        <div>
                            <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                                ...
                                <img class="size-8 rounded-full" src=" {{session('profile_photo') ? route('profile.photo', basename(session('profile_photo'))) : asset('assets/default-profile.png') }}">  
