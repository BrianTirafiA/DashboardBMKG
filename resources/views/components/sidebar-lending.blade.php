<div class="min-h-full">
    ...
    [
        ...
        'items' => [
            ['title' => 'Pengajuan', 'link' => '/transaksi-pengajuan'],
            ['title' => 'Peminjaman', 'link' => '/transaksi-peminjaman'],
            ['title' => 'Pengembalian', 'link' => '/transaksi-pengembalian'],
        ],
    ],
    [
        'type' => 'dropdown',
        ...
        'items' => [
            ['title' => 'Mingguan', 'link' => '/report-week'],
            ['title' => 'Bulanan', 'link' => '/report-month'],
            ['title' => 'Tahunan', 'link' => '/report-year']
        ],
    ],
    [
        'type' => 'dropdown',
        ...
        'items' => [
            ['title' => 'Barang / Lisensi', 'link' => '/report-week'],
            ['title' => 'Kategori', 'link' => '/report-month'],
            ['title' => 'Lokasi', 'link' => '/report-year']
        ],
    ],
    [
        'type' => 'dropdown',
        ...
        'items' => [
            ['title' => 'Pengguna', 'link' => '/report-week'],
            ['title' => 'Unit Kerja', 'link' => '/report-month'],
        ],
    ],
    [
        'type' => 'static',
