    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form untuk menambah rak -->
                <form method="POST" action="{{ route('rack.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="rackName" class="form-label">Nama Rak</label>
...
<script>
    function openAddRackModal() {
        // Logic untuk membuka modal tambah rak
        $('#addRackModal').modal('show');  // Menggunakan Bootstrap modal
    }
</script>