    ...
    @php  
        ...
        $menuItems = [
            [
                ...
                'active' => $currentRoute === 'itasset/dashboard', // Menandai aktif  
            ],
            [
                'type' => 'dropdown',
                'title' => 'Device',
            ...
            [
                ...
                'link' => '/itasset/rack',
                'active' => $currentRoute === 'itasset/rack', // Menandai aktif  
            ],
            [
                'type' => 'static',
                'title' => 'Power',
                ...
                'link' => '/itasset/power',
                'active' => $currentRoute === 'itasset/power', // Menandai aktif  
            ],
            [
                'type' => 'static',
                'title' => 'Maintenance',
                ...
                'link' => '/itasset/maintenance',
                'active' => $currentRoute === 'itasset/maintenance', // Menandai aktif  
            ],
            [
                'type' => 'static',
                'title' => 'Report',
                ...
                'active' => $currentRoute === 'itasset/report', // Menandai aktif  
            ],  
            [
                'type' => 'static',
                'title' => 'Log',
                ...
                'active' => $currentRoute === 'itasset/log', // Menandai aktif  
            ],
        ];  
    @endphp  
