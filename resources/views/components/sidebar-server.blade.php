    ...
    @php  
        ...
        $menuItems = [
            [
                ...
                'active' => $currentRoute === 'admin/itasset/dashboard', // Menandai aktif  
            ],
            [
                'type' => 'dropdown',
                'title' => 'Device',
                ...
                'items' => [
                    ['title' => 'Server', 'link' => '/admin/itasset/device/server', 'active' => $currentRoute === '/admin/itasset/device/server'],
                    ['title' => 'KVM', 'link' => '/admin/itasset/device/kvm', 'active' => $currentRoute === '/admin/itasset/device/kvm'],
                    ['title' => 'UPS', 'link' => '/admin/itasset/device/ups', 'active' => $currentRoute === '/admin/itasset/device/ups'],
                    ['title' => 'Fan', 'link' => '/admin/itasset/device/fan', 'active' => $currentRoute === '/admin/itasset/device/fan'],
                ],
            ],
            [
                'type' => 'static',
                ...
                'link' => '/admin/itasset/rack',
                'active' => $currentRoute === 'admin/itasset/rack', // Menandai aktif  
            ],
            [
                'type' => 'static',
                'title' => 'Power',
            ...
            [
                ...
                'link' => '/admin/itasset/maintenance',
                'active' => $currentRoute === 'admin/itasset/maintenance', // Menandai aktif  
            ],
            [
                'type' => 'static',
                'title' => 'Report',
            ...
            [
                ...
                'active' => $currentRoute === 'admin/itasset/log', // Menandai aktif  
            ],
        ];  
    @endphp  
