    ...
    $menuItems = [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Peminjaman', 'link' => '/user/peminjaman', 'active' => $currentRoute === 'user/peminjaman'],
        ...
        [
            ...
            'active' => false, // Kunci active untuk dropdown
            'items' => [
                ['title' => 'Barang / Lisensi', 'link' => '/user/items', 'active' => $currentRoute === 'user/items'],
                ['title' => 'Kategori', 'link' => '/user/kategori', 'active' => $currentRoute === 'user/kategori']
            ],
        ],
        ...
        [
            ...
            'active' => $currentRoute === 'user/profile', // Menandai aktif
        ],
        [
            'type' => 'static',
            'title' => 'FAQ',
