...
<div class="flex">    
    <!-- Sidebar 1 -->    
    <div id="sidebarContent" class="relative h-full min-h-[54rem] w-full max-w-[20rem] flex-col rounded-xl bg-[#F1F5F9] p-4 text-gray-700 mt-5 ms-3 mb-5 shadow-xl shadow-blue-gray-900 border border-blue-gray-100 border-collapse bg-clip-border md:block hidden">    
            ...
            <div id="account-card" class="m-2 mt-2 max-w-sm border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border">        
                <div class="rounded-xl border bg-gray-700 shadow-lg p-5">        
                    <h1 id="FullName" class="text-center text-xl font-bold {{ session('fullname') ? 'text-white' : 'text-red-500' }}">      
                        {{ session('fullname') ?? 'Nama Belum Diisi' }}      
                    </h1>          
                    ...
                    <button id="editProfileButton" type="button" class="flex justify-center mt-3 w-full bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-white">        
                        Edit Data Account        
                    </button>     
...
<script>  
    ...
    document.getElementById('editProfileButton').addEventListener('click', function() {  
        window.location.href = '/profile'; // Mengarahkan pengguna ke halaman /profile  
    }); 
