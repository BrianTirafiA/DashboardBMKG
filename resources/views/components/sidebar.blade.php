        ...
        <nav id="navMenu" class="flex flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">  
            ...
            <div id="account-card" class="m-2 mt-2 max-w-sm border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border">  
                <div class="rounded-xl border bg-gray-700 shadow-lg p-5">  
                    ...
                    <h1 id="FullName" class="mt-4 text-center text-xl font-bold text-white">Septian Eka Rahmadi</h1>  
                    <h3 id="NIP" class="text-center text-lg font-semibold text-white">5204080209030001</h3>  
                    <p class="mt-2 text-center text-sm text-white hover:text-[#F1F5F9]">Stasiun Meteorologi Kelas III Sultan Muhammad Kaharuddin, Sumbawa Besar</p>  
                    ...
                    <ul class="mt-3 divide-y rounded-xl bg-gray-100 p-3 text-gray-600 shadow-sm hover:text-gray-700 hover:shadow">  
                        <li class="flex items-center py-2 text-sm">  
                            ...
                            <span class="ml-auto"><span class="rounded-full bg-green-200 px-2 py-1 text-xs font-medium text-green-700">Lengkap</span></span>  
                        </li>  
                        <li class="flex items-center py-2 text-sm">  
