<div class="flex  ">
    <!-- Sidebar 1 -->
    <div id="sidebarContent" class="relative flex h-screen max-h-screen w-full max-w-[20rem] flex-col rounded-xl bg-[#F1F5F9]  p-4 text-gray-700 mt-5 ms-3 mb-5 shadow-xl shadow-blue-gray-900/5 border border-blue-gray-100 border-collapse bg-clip-border md:block hidden">
