   ...
   <div class="min-h-full">
    ...
    <x-navbar-user/>
       <div class="flex flex-nowrap -mt-3  ">
           ...
           <div id="sidebar2" class="xl:hidden relative flex h-[calc(150vh-2rem)] w-[3rem] flex-col rounded-xl bg-[#F1F5F9] border border-blue-gray-100 border-collapse bg-clip-border justify-center p-4 text-gray-700 mt-9 me-5 mb-7 ms-7 shadow-xl shadow-blue-gray-900 items-center md:block transition-transform duration-300">
