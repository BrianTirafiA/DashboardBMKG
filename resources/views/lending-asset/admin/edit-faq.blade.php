        ...
        <div id="table" class="relative flex flex-col w-full h-full text-gray-700 bg-[#FFFFFF] border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border mb-2">            
            <div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-[#FFFFFF] rounded-none bg-clip-border">            
                <div class="flex items-center justify-between gap-8 mb-4 ms-5 mt-2">            
                    ...
                    <div class="flex flex-col gap-2 shrink-0 me-5 sm:flex-row">      
                        ...
                        <form action="{{ route('faq.index') }}" method="GET" class="relative h-10 w-full min-w-[200px] bg-white">              
                                ...
                                <tr>            
                                    ...
                                    <td class="border-b border-blue-gray-100">            
                                        <div class="flex items-center gap-3 justify-center w-auto">            
                                            ...
                                            <form id="delete-form-{{ $pertanyaan->id }}" action="{{ route('edit-faq.destroy', $pertanyaan->id) }}" method="POST" class="inline">            
                                                @csrf              
                                                @method('DELETE')              
                                                <button type="button" class="text-red-500 flex items-center gap-1 delete-button" data-id="{{ $pertanyaan->id }}" data-question="{{ $pertanyaan->question }}" data-answer="{{ $pertanyaan->answer }}">            
                ...
                <div id="paginasi" class="flex items-center justify-between p-4 border-t border-blue-gray-50">              
                    ...
                    <div class="flex gap-2">              
                        ...
                        @else              
                            <a href="{{ $pertanyaans->previousPageUrl() . (request('search') ? '&search=' . urlencode(request('search')) : '') }}" class="select-none rounded-lg border border-gray-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-gray-900 transition-all hover:opacity-75">              
                                Previous              
                            </a>              
                        @endif              
                        @if($pertanyaans->hasMorePages())          
                            <a href="{{ $pertanyaans->nextPageUrl() . (request('search') ? '&search=' . urlencode(request('search')) : '') }}" class="select-none rounded-lg border border-gray-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-gray-900 transition-all hover:opacity-75">              
                                Next              
                            </a>              
                        @else              
                            <span class="select-none rounded-lg border border-gray-900 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-gray-900 transition-all opacity-50 cursor-not-allowed">              
            ...
            <div id="editModal" class="fixed inset-0 z-50 hidden bg-gray-800 bg-opacity-50 flex items-center justify-center border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border">              
                <div class="bg-white rounded-lg p-6 w-1/3">              
                    ...
                    <form id="editForm" action="{{ route('edit-faq.update', '') }}" method="POST" enctype="multipart/form-data">              
                        @csrf              
                        @method('PUT')        
