...
<x-lend-layout-template>
    ...
    <select name="unitkerja_id" id="addUnitKerja" required class="w-full text-sm text-gray-800 border border-gray-300 px-10 py-2 rounded-md outline-blue-600 appearance-none">  
        <option value="">Filter Periode</option>  
        <option value="sepekan">Sepekan</option>  
        <option value="satu_bulan">Satu Bulan</option>  
        <option value="satu_tahun">Satu Tahun</option>  
    </select>  
</div>  
