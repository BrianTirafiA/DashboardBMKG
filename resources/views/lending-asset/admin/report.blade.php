                    ...
                    <div class="flex items-center justify-between gap-8 mb-4 ms-5 mt-2">
                        ...
                        <div class="flex flex-col gap-2 shrink-0 me-5 sm:flex-row">
                            ...
                            <div class="relative flex items-center">
                                <div
                                    class="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none -mt-2">
                                ...
                                <form action="{{ route('report.index') }}" method="GET" class="flex items-center mb-4">
                                    <select name="periode" id="periode" onchange="this.form.submit()"
                                        class="w-full text-sm text-gray-800 border border-gray-300 px-10 py-2 rounded-md outline-blue-600 appearance-none">
                                        <option value="">Semua Periode Pengajuan</option>
                                        <option value="sepekan" {{ request('periode') == 'sepekan' ? 'selected' : '' }}>
                                            Sepekan Terakhir</option>
                                        <option value="bulanan" {{ request('periode') == 'bulanan' ? 'selected' : '' }}>
                                            Bulanan Terakhir</option>
                                        <option value="triwulan" {{ request('periode') == 'triwulan' ? 'selected' : '' }}>
                                            Triwulan Terakhir</option>
                                        <option value="semester" {{ request('periode') == 'semester' ? 'selected' : '' }}>
                                            Semester Terakhir</option>
                                        <option value="tahunan" {{ request('periode') == 'tahunan' ? 'selected' : '' }}>
                                            Satu Tahun Terakhir</option>
                                    </select>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-caret-down -ms-7 mt-1" viewBox="0 0 16 16">
                                            <path
                            ...
                            <a href="{{ route('laporan.cetak', ['periode' => request('periode'), 'search' => request('search')]) }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <path
                                        d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1" />
                                </svg>
                                Cetak Laporan
                            </a>
                        </div>
                        ...
                        <div class="w-full">
                            <div class="mb-1">
                                ...
                                <span id="modalNamaPemohon"
                                    class="block w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-md bg-gray-100"></span>
                            </div>
                            <div class="mb-4">
