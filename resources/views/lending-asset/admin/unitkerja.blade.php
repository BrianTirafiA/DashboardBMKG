...
<div>              
    <div class="me-7 mt-1">              
        ...
        <div id="table" class="relative flex flex-col w-full h-content text-gray-700 bg-[#FFFFFF] border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border mb-2">              
                                ...
                                <tr>              
                                    ...
                                    <td class="border-b border-blue-gray-100">              
                                        <div class="flex items-center gap-3 justify-center w-auto">              
                                            <button type="button" class="text-blue-500 flex items-center gap-2" onclick="openEditModal('{{ $UnitKerja->id }}', '{{ $UnitKerja->nama_unit_kerja }}', '{{ $UnitKerja->alamat }}')">                
                                            ...
                                            <form id="delete-form-{{ $UnitKerja->id }}" action="{{ route('unitkerja.destroy', $UnitKerja->id) }}" method="POST" class="inline">              
                                                @csrf                
                                                @method('DELETE')                
                                                <button type="button" class="text-red-500 flex items-center gap-1 delete-button" data-id="{{ $UnitKerja->id }}" data-nama="{{ $UnitKerja->nama_unit_kerja }}" data-alamat="{{ $UnitKerja->alamat }}">              
            ...
            <div id="addModal" class="fixed inset-0 z-50 hidden bg-gray-800 bg-opacity-50 flex items-center justify-center">              
                <div class="bg-white rounded-lg p-6 w-1/3">              
                    ...
                    <form id="addForm" action="{{ route('unitkerja.store') }}" method="POST">              
                        @csrf              
                        <div class="mb-4">              
                            <label for="addnama_unit_kerja" class="block text-sm font-medium text-gray-700">Unit Kerja / UPT</label>              
                            <input type="text" name="nama_unit_kerja" id="addnama_unit_kerja" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>              
                        </div>              
        
                        <div class="mb-4">              
                            <label for="addalamat" class="block text-sm font-medium text-gray-700">Jawaban</label>              
                            <textarea name="alamat" id="addalamat" rows="4" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required></textarea>              
                        </div>              
            ...
            <div id="editModal" class="fixed inset-0 z-50 hidden bg-gray-800 bg-opacity-50 flex items-center justify-center border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border">                
                <div class="bg-white rounded-lg p-6 w-1/3">                
                    ...
                    <form id="editForm" action="{{ route('unitkerja.update', '') }}" method="POST" enctype="multipart/form-data">                
                        @csrf                
                        @method('PUT')          
                        ...
                        <div class="mb-4">                
                            ...
                            <input type="text" name="nama_unit_kerja" id="editnama_unit_kerja" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required placeholder="Masukkan Unit Kerja / UPT">                
                        </div>                
        
                        <div class="mb-4">                
                            <label class="block text-sm font-medium text-gray-700">Jawaban</label>                
                            <textarea name="alamat" id="editalamat" rows="4" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required placeholder="Masukkan Jawaban"></textarea>                
                        </div>                
            ...
            <div id="delete-confirmation-modal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-black bg-opacity-50 border border-blue-gray-100 border-collapse shadow-md rounded-xl bg-clip-border">              
