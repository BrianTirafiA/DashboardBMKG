...
<div class="min-h-full">  
    <x-navbar :menu-items="[            
        ...
        ['label' => 'Lending Items', 'link' => '/lendasset/lendingitems', 'active' => true],            
    ...
    <div class="flex flex-nowrap">  
        ...
        <div id="sidebar2" class="hidden relative flex h-[calc(150vh-2rem)] w-[3rem] flex-col rounded-xl bg-[#F1F5F9] bg-clip-border justify-center p-4 text-gray-700 mt-9 me-5 mb-5 ms-5 shadow-xl shadow-blue-gray-900 items-center md:block hidden transition-transform duration-300">  
    ...
    document.addEventListener('DOMContentLoaded', function() {  
        ...
        function handleSidebarVisibility() {  
            if (window.innerWidth < 768) { // md breakpoint is 768px  
                ...
                sidebar2.classList.remove('hidden'); // Ensure sidebar2 is visible  
