...
<div class="min-h-screen flex items-center justify-center bg-gray-100">  
    <div id="table" class="relative flex w-1/2 flex-col text-gray-700 bg-white border border-gray-900 shadow-md rounded-xl">  
            ...
            <div class="bg-white rounded-lg p-6 w-auto">  
                ...
                <div class="flex flex-row justify-center space-x-7">  
                    <div>  
                        ...
                        <img src="{{ route('profile.photo', basename($user->profile_photo)) }}" alt="Profile Photo" class="w-32 h-32 rounded-2xl mx-auto mb-2">  
                    ...
                    <div class="">  
                        ...
                        <form action="{{ route('profile.upload.image', $user->id) }}" method="POST"  
                            ...
                            <input  
                                ...
                                required>  
                            <p class="text-sm text-gray-500" id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x800px).  
                            </p>  
                            <button type="submit"  
                                class="inline-flex py-2 px-4 border border-blue-900 rounded-md shadow-sm text-sm font-medium text-blue-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">  
                                Update Foto Profile  
                            </button>  
                        </form>  
                        ...
                        <form action="{{ route('profile.delete.image', $user->id) }}" method="POST"  
                            ...
                            @method('DELETE')  
                            <button type="submit"  
                                class="inline-flex py-2 px-4 border border-red-900 rounded-md shadow-sm text-sm font-medium text-red-600 hover:text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">  
                                Hapus Foto Profil  
                            </button>  
                        </form>  
                    </div>  
